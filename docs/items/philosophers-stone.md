...
**贤者之石把空底座当成燃料，把最近的非空底座炼成相邻编号序列里的另一件道具。**

### 空底座怎么来 / 怎么充能

- 特殊充能上限为 **3**：每接触并吸收 **1** 个空道具底座（subtype 为空）就充 **1** 格，同时移除该空座。
...
持有时 EID 会显示：当前道具 → 后续约 **5** 个编号序列候选。

**先看序列值不值得花 3 个空底座，再决定是否使用。**

简单例子：若当前是一件你不想要的道具，而序列里很快出现强力被动，就值得炼；若 5 步内都是任务/无用项，就先留着空座。

## 特殊联动

### {{Seija}}

**警告：约 75% 概率失败。** 失败时目标底座消失并在原地变成彩虹大便，等于白亏燃料与房间道具。
