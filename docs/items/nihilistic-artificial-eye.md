...
1. 拾取假眼后，获得 **2** 次“再刷出假眼”的额度。
2. 之后每次从道具池抽道具时，都有约 **1/10** 概率命中并强制生成假眼。
3. 只有成功命中（并实际消耗池抽取）才会扣 1 次额度。
4. 额度用尽前，之后每一抽都还可能再次命中。

因此两次数额可能很快用完，也可能隔很久才刷出第二次。
...
把假眼理解成“四选一入口 + 后续还有两次再遇见它的彩票”，而不是“接下来两件道具必变假眼”。
