...
**心灵之力给每份道具一层防护之心：挡下惩罚性伤害后爆开冲击波，再把护盾变成永久心。**

- 每份提供 **1** 层独立防护之心（不是普通红心/魂心）
- 只抵挡**惩罚性真实伤害**（假伤、恶魔交易、献血袋、诅咒门等不会触发）
- 触发时：抵消伤害 → 消耗 1 层 → 释放大范围心灵冲击波 → 转化为 **+1** 心之容器（魂心角色给魂心）
- 冲击波伤害大约是「十余倍角色攻击再加一截固定伤」
- 被本次冲击波**直接击杀**的敌人：永久 {{Damage}} 小幅提升、{{Shotspeed}} 略降；每波最多计 **5** 次击杀成长
- 房间内敌人很多（约 **5** 个及以上）时：冲击波无视护甲，并向本层其他房间传播

## 注意

成长是跨房间永久的，不是单房临时 buff。

## 使用技巧

故意去接一次“真伤惩罚”来换钱心与清房冲击波前，先确认房间怪量：怪多时传播收益更高。
