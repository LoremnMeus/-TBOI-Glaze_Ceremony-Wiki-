...
**天象解构会把本层的一些特殊房移到正常地图之外。想进入这些房间，需要用它提供的红钥匙碎片重新开路。**
...
例如，原本正常连接在地图上的商店或宝箱房可能突然不在普通路线里了。它们并没有消失；找到之后仍然是原来的商店或宝箱房，只是现在需要通过新开的红房间重新进入。

### 哪些房间可能被移走

天象解构只会选择普通大小、四面都可以生成房门的特殊房。
...
如果本层没有足够多符合条件的特殊房，实际被移走的房间会更少。

## 注意

红钥匙碎片并不会直接告诉你被移走的房间在哪里。

需要像平常开启红房间一样逐步探索；每间被移走的特殊房第一次进入时都会返还 1 张红钥匙碎片。
