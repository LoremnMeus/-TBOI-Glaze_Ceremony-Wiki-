...
每层开始时，按持有份数生成红钥匙碎片（基准约 **份数 + 2**，常见为 3 张）。随后，最多把若干间特殊房与地图外的红房位交换。

### 实际探索例子

原本地图里的商店、宝箱房等可能被“撕”到地图外。你拿着红钥匙碎片，沿着可能相连的墙边开红房；第一次找到一间被移走的特殊房时会返还 **1** 张碎片，因此可以继续找下一间。

### 什么会被移动

- 通常是 **1×1、四门齐全** 的特殊房，而不是普通战斗房或 Boss 房。
- 实际能移走几间取决于本层有多少合格特殊房，以及你持有几份；不是每层都恰好 4 间。
- 被移动后仍保留原来的房型内容（商店还是商店，宝箱房还是宝箱房），只是入口变成红房路线。

## 使用技巧

- 优先检查与起始房、已探索走廊相邻、看起来“缺了一块”的墙边。
- 返还的碎片是续航：找到一间就能再开一段。
- 多份持有会同时提高起始碎片与可移动上限。
