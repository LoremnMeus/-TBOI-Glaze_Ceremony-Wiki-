...
**灵感的情绪是：平时看得到拿不到，濒死才成真。**

### 幻像何时出现

清理房间后约 **60%** 概率生成一个奖励幻像。

### 为什么越来越明显

生命越低，幻像越亮、越“实”。高生命时它们更像半透明诱惑；掉到危险线时才像真正的掉落。

### 怎样才能拿走

只有绝对生命降到约 **1** 格时，触碰才会把幻像实体化。生命更高时会被推开，拿不到。
...
先清房看有没有诱人的幻像道具；若值得为它赌命，再把生命压到可触碰线。
