...
**倍增重刃会消耗当前全部充能挥出一刀；每多 1 格充能，刀刃的伤害和范围都会再次翻倍。**

- {{Battery}} 至少 **1** 格即可使用，并消耗当前全部充能
- {{Damage}} **1** 格造成 **100%** 角色攻击；每多 1 格，伤害再翻一倍
- 刀刃体积也随充能变大；充能很高时体积与碰撞会达到上限
...
低充能适合清小怪；Boss 前尽量攒满再挥。看到充能很高时刀会变沉、变大，预留走位空间。
