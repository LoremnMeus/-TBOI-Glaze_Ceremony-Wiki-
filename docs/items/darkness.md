...
暗之六面把生命改成魂心体系，再让黑心同时成为生命、攻击力、成长目标和恶魔交易货币。

持有后（REPENTOGON 下）角色生命类型变为魂心；道具本身提供 **+1** 黑心。

攻击力随黑心数量增长：每个黑心大约提供 **+0.8** 攻击，并额外附带每个黑心约 **0.3%** 的乘算；重复持有会进一步提高加算部分。
...
- 普通魂心不是「次等黑心」：击杀可以把它们染成黑心，魂心奖励也是未来攻击储备。
...
- 非 REPENTOGON 环境下会把红心容器转为黑心（Keeper 等特例保留部分容器）。
