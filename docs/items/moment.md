...
- 残余能量本身会造成少量碰撞伤害，但主要用途是返回角色并提供属性。
- 零点反转期间，常规攻击不会继续生成新的残余能量。
- 属性成长具有递减收益，并不是每份能量都提供相同的面板增量。

## 使用技巧

- 持续时间长或攻击频率高的攻击更容易稳定产生残余能量，也更容易进入自动泄压区间。
- 接近过载时继续快速回收能量可能跨过零点反转阈值；需要稳定属性时，应给晨星装置留出泄压时间。

## 特殊联动

### {{Seija}}

在 Seija 的影响下，晨星装置无法泄露能量。属性可以继续积累，但一旦触发零点反转，便不会再靠自然泄压恢复。

## 轶事

- 名称与「零点反转」灵感来自游戏王 5D's 的 MOMENT / Zero Reverse。
