---
title: 琉璃之福袋
description: "消耗富余的硬币/钥匙/炸弹，生成对应琉璃掉落 硬币>5、钥匙>1、炸弹>1才会计入 最多约3份 便便 没有可消耗资源时生成琉璃便便"
slug: glaze-grabbag
kind: pickup
...
若完全没有可转化的富余资源，改为生成 {{Pickup:glaze-big-poop}}。

局里有便便角色时：若某份随机结果本来是炸弹，则**必定**改为生成琉璃之便便，但仍按炸弹扣除库存（不额外扣便便法力）。
