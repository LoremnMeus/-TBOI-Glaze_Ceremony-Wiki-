...
status: reviewed
---
<p class="wiki-search-index" v-pre>XXI - 宇宙 XXI - The Universe Universe xxi-the-universe XXI - The Universe 星汉灿烂 Ever shinning 从你持有的道具中随机展示3个候选 选择并永久失去其中1件，换取1件星辰类道具 Show up to 3 random candidates from items you hold Permanently lose the chosen one for 1 star-themed item</p>
...
使用后，从玩家持有的道具中随机展示最多 **3 件**作为祭品候选。

接触其中一个候选后，会永久失去对应道具，随后获得 1 件来自固定星辰池的道具。
