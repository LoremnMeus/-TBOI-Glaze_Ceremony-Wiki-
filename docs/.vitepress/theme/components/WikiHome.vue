...
const systems = computed(() => [
  ...
  { title: english.value ? 'Knowledge & Associations' : '知识与联想', text: english.value ? 'Store items as knowledge, then borrow nearby associations floor by floor.' : '将道具保存为知识，并按楼层借用附近的联想。', link: '/systems/death-certificate-knowledge' },
])
