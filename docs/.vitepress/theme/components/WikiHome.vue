...
const systems = computed(() => [
  ...
  { title: english.value ? 'Death Certificate & Knowledge' : '死亡证明与知识', text: english.value ? 'Turn items into knowledge and uncover relationships between them.' : '将道具转化为知识，并从知识之间寻找关联。', link: '/systems/death-certificate-knowledge' },
])
