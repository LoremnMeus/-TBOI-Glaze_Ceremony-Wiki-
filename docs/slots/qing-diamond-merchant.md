---
title: 钻石收购商
description: "靠近后选择出售价格 碰触商人完成定价交易 按RT暂时取消"
slug: qing-diamond-merchant
kind: slot
internalKey: Qing_Diamond_Merchant
status: featured
---
<p class="wiki-search-index" v-pre>钻石收购商 Diamond Merchant Qing_Diamond_Merchant qing-diamond-merchant Qing_Diamond_Merchant 靠近后选择出售价格 碰触商人完成定价交易 按RT暂时取消 Choose a sale price nearby Walk into the merchant to confirm the trade Press RT to cancel temporarily</p>
