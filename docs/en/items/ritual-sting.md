...
**Ritual Sting charges six colors through sacrifice and champion kills. Crossing thresholds rewrites your build; clearing rooms slowly drains every color.**
...
| Threshold | Effect |
| --- | --- |
| 0% | Take double damage |
| <50% | −0.2 damage multiplier |
| >90% | +0.5 damage multiplier |
| >150% | +3 Damage |
| >250% | Count as having {{Collectible:118}} |
...
| <50% | −2 Luck |
| >90% | +4 Luck |
| >150% | Double room-clear rewards |
| >250% | Double item generation |

### Yellow

| Threshold | Effect |
| --- | --- |
| 0% | Holy light chases you |
| <50% | −2 Range |
| >90% | +5 Range |
| >150% | Color gain ×1.5 |
...
| Threshold | Effect |
| --- | --- |
| 0% | Enemies leave creep |
| <50% | −0.5 Tears |
| >90% | +2 Tears |
| >150% | Tears multiplier ×1.5 |
| >250% | Your attacks leave creep |
