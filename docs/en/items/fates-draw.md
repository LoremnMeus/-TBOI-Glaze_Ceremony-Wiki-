...
Each occupied card slot cycles through cards of the same type, and multiple slots roll independently.
...
The first copy changes cards about every 24 frames. Each extra copy adds 8 frames to the interval, up to 56.
