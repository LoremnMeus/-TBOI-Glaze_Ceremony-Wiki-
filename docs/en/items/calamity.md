...
Boss rooms can be calamitized. If a critical Boss room is cleared early, the run still places needed exits (trapdoors, chest routes, Void routes, etc.) so progress is not soft-locked.

## Notes

- The target room must still be uncleared.
