---
title: Glaze Grabbag
description: "Convert surplus coins/keys/bombs into glazed pickups Only coins>5, keys>1, bombs>1 count Up to about 3 Spawns a glaze poop if nothing to convert"
slug: glaze-grabbag
kind: pickup
...
If nothing can be converted, spawn {{Pickup:glaze-big-poop}} instead. When a poop character is in the run, bomb conversions may become Glaze Poop instead.
